...
| 0.2 | `sorted()` diff keys and every other dict iteration; assert byte-identical output across repeated runs under `PYTHONHASHSEED=random` | **D2** | ✅ Done — `changes/deterministic-report-output` |
