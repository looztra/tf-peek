...
- [x] 1.1 Add an eager `--version`/`-V` option to the `generate` command in `src/tf_peek/main.py`
...
- [x] 1.3 Add a regression test asserting `tf-peek generate plan.json` still exits non-zero
...
- [x] 2.5 Fix `docs/reference/cli.md`: usage synopsis and all example invocations; verify/correct
...
- [x] 3.1 Rewrite the "Filter resources" step of
